...
2
2024-10-21 18:05:54
INSERT INTO storefront.order ( order_date) VALUES ('2024-10-21 18:05:54')
INSERT INTO storefront.order (order_date)  VALUES ('2024-10-21 18:05:54')
New Order = -1
...
2
2024-10-22 09:27:07
INSERT INTO storefront.order ( order_date) VALUES ('2024-10-22 09:27:07')
INSERT INTO storefront.order (order_date)  VALUES ('2024-10-22 09:27:07')
New Order = 1
...
*/
/// Delete method has not included delete from OrderDetails table. Because, OrderDetais table creation has it.
...
//            System.out.println("New Order = " +  newOrder);
    ...
    private static void deleteOrder ( Connection conn, int orderId ) {
        ...
        try ( Statement statement = conn.createStatement()) {
            int deleteRecords = statement.executeUpdate(deleteQuery);

            System.out.printf("%d records delete%n", deleteRecords );
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }
...
/// Added orderDetail deleting part on delete method
import com.mysql.cj.jdbc.MysqlDataSource;
...
Order 3 was successfully deleted 
