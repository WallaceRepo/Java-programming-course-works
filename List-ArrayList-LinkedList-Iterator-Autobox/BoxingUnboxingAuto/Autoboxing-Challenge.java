...
public class AutoboxingUnboxing {
    ...
    public static void main(String[] args) {
        ...
        // Bank@65b3120a   // standard toString method text for a class. So gonna create toString method on Bank class using IDE code generator tool
  // result of override toString
